...
class InMemoryHistoryStore:
    ...
    # 便捷方法：更语义化
    def record_user(self, thread_id: str, content: str, tags: Optional[Sequence[str]] = None):
        return self.append(thread_id, "用户", content, tags)

    def record_speaker(self, thread_id: str, speaker: str, content: str, tags: Optional[Sequence[str]] = None):
...
# 全局单例：主程序里直接用 history_store.record_*()
