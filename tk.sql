...
CREATE TABLE `comments`  (
  ...
  `deleted_by` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '删除者ID（管理员）',
  `delete_reason` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '删除原因',
  `is_violation` tinyint(1) NULL DEFAULT 0 COMMENT '是否违规',
  `violation_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '违规类型（对应违禁词分类）',
  `matched_word` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '匹配到的违禁词',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  ...
  INDEX `idx_is_violation`(`is_violation` ASC) USING BTREE,
  CONSTRAINT `fk_comment_deleted_by` FOREIGN KEY (`deleted_by`) REFERENCES `users` (`user_id`) ON DELETE SET NULL ON UPDATE RESTRICT,
...
) ENGINE = InnoDB AUTO_INCREMENT = 162 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '共识点表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 164 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '争议点表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `email_verification_codes`  (
  ...
  `purpose` enum('register','reset_password','change_password','bind_email') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- ----------------------------
INSERT INTO `email_verification_codes` VALUES (9, '19139928238@163.com', '254735', 'register', '2026-01-04 14:25:20', 1, '2026-01-04 14:15:19');
...
CREATE TABLE `forbidden_words`  (
  `word_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `word` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '违禁词',
  `category` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '其他' COMMENT '分类',
  `severity` int(11) NULL DEFAULT 1 COMMENT '严重程度(1-轻微,2-中等,3-严重)',
...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '违禁词表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of forbidden_words
-- ----------------------------
...
) ENGINE = InnoDB AUTO_INCREMENT = 450 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '开放问题表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 322 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '风格健康统计表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 26 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '对话点赞表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 44 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '对话所有者表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of thread_owners
-- ----------------------------
...
-- ----------------------------
INSERT INTO `user_sessions` VALUES ('57d41d354d7545589afff54222346cf8', 'eb76e5364b464834bda377bf2fbb7bab', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoiZWI3NmU1MzY0YjQ2NDgzNGJkYTM3N2JmMmZiYjdiYWIiLCJ0eXBlIjoicmVmcmVzaCIsImV4cCI6MTc3MDA5OTM2NCwiaWF0IjoxNzY3NTA3MzY0fQ.YoWNo5X1MR8NZ-TuF5m_uG53z7JL8SYD8QiXZqM3n3s', '2026-01-04 14:16:04', '2026-02-03 14:16:05');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('2771f35b3eae4b8287e65819aab08e0e', 'admin', 'example@1456.com', 'c0e3197cf7ca8a3a537edb32d694bc07649bbf16b314805353210e6274d50f08', NULL, 1, 0, 'admin', '2026-01-04 14:17:14', '2026-01-04 14:17:14', NULL, 0, NULL, NULL, NULL);
INSERT INTO `users` VALUES ('53bbf2f0c08e406fa46abf8c9c03c154', 'user', 'example@135.com', 'c0e3197cf7ca8a3a537edb32d694bc07649bbf16b314805353210e6274d50f08', NULL, 1, 0, 'user', '2026-01-04 14:17:50', '2026-01-04 14:17:50', NULL, 0, NULL, NULL, NULL);
INSERT INTO `users` VALUES ('eb76e5364b464834bda377bf2fbb7bab', 'spadmin', 'example@123.com', '52503e0b77fa62e6d3cee0c47bbe532877ac722e4ccaa9e4ee75efc7ef93ffb1', NULL, 1, 1, 'super_admin', '2026-01-04 14:15:38', '2026-01-04 14:16:29', '2026-01-04 14:16:05', 0, NULL, NULL, NULL);
